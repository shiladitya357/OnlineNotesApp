...
$message .= "http://localhost/NotesAppFinal/activate.php?email=" . urlencode($email) . "&key=$activationKey";

$subject = "Confirm Your Registration";
$headers= "From: shiladitya997@gmail";
...
if($success){
  ...
  echo "<div class='alert alert-success'>Eh. Nahi hua.</div>";
}
